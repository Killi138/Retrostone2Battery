...
sudo cp src/functional_zdoom/zdoom /opt/retropie/ports/zdoom/zdoom
sudo cp src/functional_zdoom/zdoom.pk3 /opt/retropie/ports/zdoom/zdoom.pk3
...
sudo cp src/functional_zdoom/Doom_1.sh /home/pi/RetroPie/roms/ports/Doom_1.sh
sudo cp src/functional_zdoom/Doom_1\ Controller.sh /home/pi/RetroPie/roms/ports/Doom_1\ Controller.sh
...
cp src/functional_zdoom/zdoom.ini_doom_retrostone /home/pi/.config/zdoom/zdoom.ini_doom_retrostone
cp src/functional_zdoom/zdoom.ini_doom_controller /home/pi/.config/zdoom/zdoom.ini_doom_controller
